...
static const unsigned int gappx     = 74;        /* gaps between windows */
...
static const int sidepad            = 156;       /* horizontal padding of bar */
static const char *fonts[] = {"Naturaly:size=28", "JetBrainsMonoNerdFont-Bold:size=25"};
static const char dmenufont[] = "Naturaly:size=25";
static char normbgcolor[]           = "#101319";
static char normbordercolor[]       = "#101319";
static char normfgcolor[]           = "#ffffff";
static char selfgcolor[]            = "#ffffff";
static char selbordercolor[]        = "#101319";
